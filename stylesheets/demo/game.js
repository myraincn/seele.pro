...
titleScreen.prototype = {
    create: function(){
        ...
        //game.add.bitmapText(game.width / 2, game.height - 100, "bignumbersfont", score.toString(), 90).anchor.set(0.5);
    },
    startGame: function(){
...
gameOver.prototype = {
    create: function(){
        ...
        game.add.bitmapText(game.width / 2, game.height - 100, "font", bestScore.toString(), 90).anchor.set(0.5);
